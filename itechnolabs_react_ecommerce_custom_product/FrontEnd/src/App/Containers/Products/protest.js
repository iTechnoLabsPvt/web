...
import { Button, message, Spin, Upload, Modal, Switch } from "antd";
import {
  addToCart,
  addToCartService,
  updateCartService,
        ...
        if (res.status) {
          ...
          if (res.data.available_sizes.length) {
            _.each(res.data.available_sizes, (obj) => {
              ...
              sizes[obj.size] =
                res.data.product_detail.moq / res.data.available_sizes.length;
              return;
            });
          }
          context.setState(
  ...
  uploadDesign = async (file, ele) => {
    ...
    if (
      ...
      reader.onload = async function () {
        ...
        context.setState({ fileList: fileList, currentEmbellishingArea: ele });
          ...
          <div className="product-modal-left-outer">
            <div className="product-modal-left">
              ...
              fileList[currentEmbellishingArea].currentEmbellishingColors
                ...
                <div className="product-modal-title">
                  Colors detected from uploaded file:
                </div>
              )}
              {colors.map((color, id) => (
                <div key={id} className="color-div-outer">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      this.deleteColor(id, currentEmbellishingArea)
                    }
                  >
            ...
            <div className="confirm-btn-outer">
              <Button
                className="common_btn_product"
                onClick={() => {
                  this.confirmAndAddDesign();
                }}
                disabled={
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="product_left_side">
                      ...
                      <div className="product_images" id="images">
                                ...
                                <div key={i} id={`cnvs_${ele.area}`}>
                                  ...
                                  <div
                                    ...
                                    style={{
                                      ...
                                      width:
                                        ele.area == "Side" ? "70px" : "80%",
                                      height:
                                        ele.area == "Side" ? "83px" : "400px",
                                      ...
                                      this.state.fileList[ele.area]
                                        ...
                                        <div>
                                          <Moveable
                                            ...
                                            edge={true}
                                            // snappable = {true}
                                            // bounds = {{"left": 0,"top": 0,"right": ele.area == 'Side' ? 70 : 160,"bottom": ele.area == 'Side' ? 83 : 210}}
                                            draggable={true}
                                            throttleDrag={0}
                                            padding={{
                                              left: 0,
                                            ...
                                            onResize={({
                                              ...
                                              fileList[ele.area] = {
                                                ...fileList[ele.area],
                                                translateResize: beforeTranslate,
                                                width,
                                                height,
                                              };
                                              context.setState({ fileList });
                                            }}
                                            onDragStart={({ set }) => {
                                            ...
                                            onDragEnd={({ target,isDrag,clientX, clientY }) => {
                                              ...
                                              let clientHeight = document.getElementById('outer_div_drag_'+ele.area).clientHeight;
                                              let distance_top = document.getElementById('outer_div_drag_'+ele.area).getBoundingClientRect().top;
                                              let imageHeight = document.getElementById('canvas_'+ele.area).clientHeight;
                                              let distance_top_image = document.getElementById('canvas_'+ele.area).getBoundingClientRect().top;
                                              let drop_area_dim = document.getElementById('outer_div_drag_'+ele.area).getBoundingClientRect();
                                              let image_area_dim = document.getElementById('canvas_'+ele.area).getBoundingClientRect();
                                               if(image_area_dim.x < drop_area_dim.x || image_area_dim.x > (drop_area_dim.x+drop_area_dim.width) )
                                               {
                                                console.log('image outside the div');
                                                let fileList = this.state.fileList;
                                                fileList[ele.area] = {
                                                  ...fileList[ele.area],
                                                  translate: [0, 0],
                                              ...
                                              if(distance_top_image < distance_top)
                                              {
                                                let fileList = this.state.fileList;
                                                fileList[ele.area] = {
                                                  ...fileList[ele.area],
                                              ...
                                              if(distance_top_image > (distance_top+clientHeight))
                                              {
                                                let fileList = this.state.fileList;
                                                fileList[ele.area] = {
                                                  ...fileList[ele.area],
                                              ...
                                              console.log(clientHeight,"== div height");
                                              console.log(distance_top,"=== distance top");
                                                console.log(clientX,"== x");
                                                console.log(clientY,"== y")
                                                console.log(distance_top_image,"== image distance top")
                                  ...
                                  {this.state.fileList[ele.area] &&
                                    this.state.fileList[ele.area]
                                      .confirmDesign && (
                                      <Button
                                        className="common_btn_product center-logo-btn"
                                        onClick={() => {
                                          let fileList = this.state.fileList;
                                          fileList[ele.area] = {
                                            ...fileList[ele.area],
