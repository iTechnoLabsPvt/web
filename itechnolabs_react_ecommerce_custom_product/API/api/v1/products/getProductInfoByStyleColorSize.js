import Joi from 'joi';
import { getProductInfoByStyleColorSize } from '../../../controllers/products';

export default {
  method: 'GET',
  path: '/api/v1/products/detail/get/style-color-size',
  config: {
    auth: false,
    description: 'Api service used to get product detail by style color size.',
    notes:
  ...
  handler: getProductInfoByStyleColorSize
};
